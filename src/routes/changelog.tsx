        ...
        <div className="mx-auto px-4 py-6 max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
              <Logo onlyIcon />
              <ul className="flex flex-wrap items-center gap-1 sm:gap-0">
                <Link to="/">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-2 w-full md:w-auto">
              ...
              <div className="flex items-center gap-2">
                <Separator className="h-[17px!important] hidden sm:block" orientation="vertical" />
                <div className="font-medium text-green-400 text-xs">All services are online</div>
              </div>
            </div>
          </div>
          <div className="py-2 text-xs text-center mt-4 md:mt-0">
