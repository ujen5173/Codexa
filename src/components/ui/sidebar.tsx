          ...
          style={
            {
              ...
              "--sidebar-offset-top": `${offsetTop}px`,
              ...style,
            } as React.CSSProperties
          }
          className={cn(
            "group/sidebar-wrapper flex has-data-[variant=inset]:bg-sidebar w-full h-full",
            className
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-[calc(100svh)-var(--sidebar-offset-top))] top-(--sidebar-offset-top) w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
